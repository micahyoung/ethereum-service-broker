...
describe "EthereumServiceHelper" do
  describe "parse_logs" do
    it "parses init message" do
      ...
      assert_equal("8ba26367c9651a53880326ea2065da08c6f7ee744afcf3c0ab7dfe3457542fd2d467f57cff69729602427593beb6e1cadd01b0d122caf22120cb1e204ffbec72@10.242.186.135:33445", ethereum_service_helper.bootnode)
    end

    it "parses broker_env message" do
      ethereum_service_helper = EthereumServiceHelper.new
      ethereum_service_helper.parse_log("2017-10-15T17:37:45.90-0400 [APP/PROC/WEB/0] ERR INFO BOOTNODE=8ba26367c9651a53880326ea2065da08c6f7ee744afcf3c0ab7dfe3457542fd2d467f57cff69729602427593beb6e1cadd01b0d122caf22120cb1e204ffbec72@10.242.186.135:33445\n")
      assert_equal("8ba26367c9651a53880326ea2065da08c6f7ee744afcf3c0ab7dfe3457542fd2d467f57cff69729602427593beb6e1cadd01b0d122caf22120cb1e204ffbec72@10.242.186.135:33445", ethereum_service_helper.bootnode)
    end
    ...
    it "parses older init message" do
      ...
      assert_equal("61077a284f5ba7607ab04f33cfde2750d659ad9af962516e159cf6ce708646066cd927a900944ce393b98b95c914e4d6c54b099f568342647a1cd4a262cc0423@10.252.26.21:33445", ethereum_service_helper.bootnode)
    end
